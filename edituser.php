    ...
    if(isset($_POST['simpan'])){
        ...
        if($password1 != "" && $password2 != ""){
            if($password1 == $password2){
                ...
                $up = mysqli_query($conn, "update tbuser set nama_user='$nama', username='$username', passowrd='$pass', where iduser=$iduser");
            }else{
...
<form action="?hal=edituser" method="post">
        <table>
            ...
            <tr>
                <td>Nama User</td>
                <td>
                    <input type="text" name= "nama" placeholder="Nma User" required value="<?=$data['nama_user']?>">
                </td>
            </tr>
            <tr>
                <td>Username</td>
            ...
            <tr>
                ...
                <td>
                    <input type="passowrd" name="password2" placeholder="Password">
                </td>
            </tr>
            <tr>
                <td>
